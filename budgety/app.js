...
var budgetController = (function () {
    ...
    return {
        ...
        calculateBudget: function () {
            ...
            //calcutae the percentage of income that we spent
...
var UIController = (function () {
    ...
    return {
        ...
        addLsitItem: function (obj, type) {
            ...
            //Replace with place holder with some actual data
        ...
        displayPercentage: function (percentages) {
            var field = document.querySelectorAll(DOMString.expensesPercentageLabel);
...
var controller = (function (budgetCtrl, UICtrl) {
    ...
    var updateBudget = function () {
        ...
        //   6. DIsplay the budget ont the UI.
    ...
    ctrlAddItem = function () {
        ...
        if (input.description !== "" && !isNaN(input.value) && input.value > 0) {
            ...
            //   3. Add the item UI Controller,
            UICtrl.addLsitItem(newItem, input.type);
